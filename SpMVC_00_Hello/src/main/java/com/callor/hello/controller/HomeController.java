...
import com.callor.hello.HomeService;
import com.callor.hello.models.StudentDto;

/**
 * 여기는 controller 클래스이다 라우터 역할같은 느낌
 */
@Controller
...
//	제어의 역전
//	일반적인 자바코드에서 어떤 클래스를 사용하여 만든 객체의 method 나 속성(변수)에
//	접근하기 위해서는 반드시 객체를 선언하고 생성자를 통하여 객체를 생성(초기화 )해야한다.
...
//	Spring Container 에 미리 준비된 컴포넌트(객체, bean) 를 주입해준다
